...
preguntas = [
    ("¿En qué categorías pueden agruparse las conexiones de un router Cisco?", [
        ...
        "q) Es un puerto de administración lógica que proporciona acceso en banda a un dispositivo de Cisco.",
        "w)  Es un puerto de administración físico que proporciona acceso fuera de banda a un dispositivo de Cisco.",
        "e) Es un puerto de administración lógica que proporciona acceso fuera de banda a un dispositivo de Cisco.",
        "r) Es un puerto de administración físico que proporciona acceso en banda a un dispositivo de Cisco."
    ], "w"),
