...
preguntas = [
    ...
    ("¿Por qué las ranuras para tarjeta de interfaz WAN tienen el rótulo eHWIC 0 y eHWIC 1?", [
        ...
        "e) Para proporcionar modularidad y flexibilidad al permitir que el router admita distintos tipos de módulos de interfaz, sin incluir serial, línea de suscriptor digital (DSL), puerto de switch y tecnología inalámbrica.",
